...
<section className="relative py-20 overflow-hidden">
  <div className="relative container px-4 mx-auto">
    <div className="max-w-full">
      <div className="pb-10 mb-10 items-center">
        <div className="flex flex-wrap -mx-4 items-center">
          <div className="w-full lg:w-1/2 px-4 mb-4 lg:mb-0">
            ...
            <img className={`h-20 ${darkMode ? 'grayscale invert' : 'grayscale-0 invert-0'}`} src="/brands/sr12.png" alt="" />
            </a>
          </div>
          <div className="w-full lg:w-1/2 px-4">
            <div className="sm:flex -mb-4 items-center lg:justify-end">
              <span className="inline-block mb-4 mr-8">Tertarik menjadi Mitra ?</span>
      ...
      <div className="w-full lg:w-2/5 px-4 mb-12 lg:mb-0 flex items-center"> {/* Added 'flex' and 'items-center' */}
  <div className="xs:max-w-xs">
    <h4 className="font-heading text-2xl font-semibold mb-4">Subscribe to our newsletter</h4>
    <form action="">
      <div className="flex items-center mb-4"> {/* Added 'flex' and 'items-center' */}
        <div className="relative mr-4"> {/* Removed 'mb-4' and added 'mr-4' */}
          ...
          <input
className={`w-full p-12 pr-4 py-4 text-sm ${darkMode ? 'text-gray-100 bg-gray-800' : 'text-gray-500 bg-gray-200'} rounded-lg`}
type="email"
            placeholder="alfinas.sandi@cmmgroup.co.id"
          />
        </div>
        ...
        <div className="w-full sm:w-1/3 lg:w-1/5 px-4 mb-8 sm:mb-0">
          <h5 className="text-lg font-semibold mb-4">Halaman</h5>
          <ul>
            <li className="mb-4"><a className="inline-block hover:text-gray-600" href="#">Tentang</a></li>
            <li className="mb-4"><a className="inline-block hover:text-gray-600" href="#">Produksi</a></li>
            <li className="mb-4"><a className="inline-block hover:text-gray-600" href="#">Distribusi</a></li>
          </ul>
        </div>
        <div className="w-full sm:w-1/3 lg:w-1/5 px-4 mb-8 sm:mb-0">
          <h5 className="text-lg font-semibold mb-3">Brand</h5>
          <ul>
            <li className="mb-4"><a className="inline-block hover:text-gray-600" href="#">SR12 Skin Care</a></li>
            <li className="mb-4"><a className="inline-block hover:text-gray-600" href="#">SR12 Herbal</a></li>
            <li className="mb-4"><a className="inline-block hover:text-gray-600" href="#">SR KIDDOS</a></li>
            <li className="mb-4"><a className="inline-block hover:text-gray-600" href="#">SR12 for Men</a></li>
            <li className="mb-4"><a className="inline-block hover:text-gray-600" href="#">SKINSANE</a></li>
          </ul>
        </div>
        <div className="w-full sm:w-1/3 lg:w-1/5 px-4">
          <h5 className="text-lg font-semibold mb-4">Help</h5>
          <ul>
            <li className="mb-4"><a className="inline-block hover:text-gray-600" href="#">FAQs</a></li>
            <li><a className="inline-block hover:text-gray-600" href="#">Contact Us</a></li>
          </ul>
        </div>
      </div>
      <div className="sm:flex items-center justify-between">
        <div className="sm:flex mb-6 sm:mb-0 items-center"><a className="inline-block mr-6 sm:mr-12 hover:text-gray-600" href="#">Terms & Conditions</a><a className="inline-block hover:text-gray-600" href="#">Privacy Policy</a></div>
